...
create table jenis_pelayanan(id varchar(10), nama_pelayanan VARCHAR(30), tanggal DATE, hari VARCHAR(10), jam_buka TIME, jam_tutup TIME);
create table loket(id_antrian VARCHAR(10), id_pelayanan VARCHAR(10), waktu_daftar TIMESTAMP);
